...
heroImage: /assets//assets/images/services/weather-radar/pages/weather-radar-dome.jpg
            ...
            <div class="rich-content">
                ...
                <div class="zigzag-section">
                    ...
                    <div class="zigzag-image">
                        <img src="/assets//assets/images/services/weather-radar/pages/s-band-radar.jpg" alt="Dual-Polarization Radar">
                    </div>
                </div>
                ...
                <div class="zigzag-section reverse">
                    ...
                    <div class="zigzag-image">
                        <img src="/assets//assets/images/services/weather-radar/pages/c-band-radar.jpg" alt="Clutter Suppression">
                    </div>
                </div>
                ...
                <div class="gallery-section">
                    ...
                    <div class="gallery-grid">
                        <div class="gallery-item">
                            <img src="/assets//assets/images/services/weather-radar/pages/x-band-radar.jpg" alt="Urban X-Band Radar">
                            <div class="gallery-caption">Compact X-Band deployment for urban hydrology.</div>
                        </div>
                        <div class="gallery-item">
                            <img src="/assets//assets/images/services/weather-radar/pages/surabaya-radar-dome.jpg" alt="Radar Tower">
                            <div class="gallery-caption">Self-supporting structural tower installation.</div>
                        </div>
                        <div class="gallery-item">
                            <img src="/assets//assets/images/services/weather-radar/pages/weather-supercomputer.jpg" alt="Radar Console">
