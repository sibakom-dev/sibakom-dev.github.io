...
heroImage: /assets//assets/images/services/lidar-monitoring/pages/lidar-laser-beam.jpg
            ...
            <div class="rich-content">
                ...
                <div class="zigzag-section">
                    ...
                    <div class="zigzag-image">
                        <img src="/assets//assets/images/services/lidar-monitoring/pages/x-band-radar.jpg" alt="LiDAR Beam">
                    </div>
                </div>
                ...
                <div class="zigzag-section reverse">
                    ...
                    <div class="zigzag-image">
                        <img src="/assets//assets/images/services/lidar-monitoring/pages/corporate-building.jpg" alt="Urban Profiling">
                    </div>
                </div>
                ...
                <div class="gallery-section">
                    ...
                    <div class="gallery-grid">
                        <div class="gallery-item">
                            <img src="/assets//assets/images/services/lidar-monitoring/pages/lidar-laser-beam.jpg" alt="Vertical Profile">
                            <div class="gallery-caption">Time-series backscatter profiling.</div>
                        </div>
                        <div class="gallery-item">
                            <img src="/assets//assets/images/services/lidar-monitoring/pages/c-band-radar.jpg" alt="Depolarization Map">
                            <div class="gallery-caption">Volcanic ash depolarization ratio.</div>
                        </div>
                        <div class="gallery-item">
                            <img src="/assets//assets/images/services/lidar-monitoring/pages/broadcast-studio-green-screen.jpg" alt="3D Scan">
