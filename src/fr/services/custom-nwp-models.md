---
permalink: /fr/services/custom-nwp-models/
layout: layouts/page.njk
title: Modèle et analyse PNT Khusus
...
sections:
  - title: Penurunan Skala WRF
    ...
    text: >-
      Kami menerapkan versi model Penelitian et Peramalan Cuaca (WRF) yang
      dioptimalkan pada node Komputasi Kinerja Tinggi (HPC) yang dilokalisasi.
      Hal ini memungkinkan kami menyelesaikan dinamika atmosfer pada jarak
      grille 1 km hingga 3 km.





      - Menangkap zona konvergensi angin laut.


      - Secara akurat memodelkan pengangkatan orografis di atas medan vulkanik.


      - Terminal Menghasilkan perkiraan penerbangan yang sangat spesifik.
  - title: Asimilasi Data Tingkat Lanjut
    image: /assets/images/pages/engineering-team.jpg
    text: >-
      Sebuah modèle hanya akan sebaik keadaan awalnya. Nous utilisons des
      techniques similaires à 3DVAR et 4DVAR pour observer des données en temps
      réel (radar, projecteurs et modèles AWS) - un modèle simple.





      - Asimilasi kecepatan radial radar pour tuk medan angin.


      - Penerimaan pancaran satelit pour inisialisasi cloud.


      - Il s'agit d'une version "spin-up" qui signifie.
---
